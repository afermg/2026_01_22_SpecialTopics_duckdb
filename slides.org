...
These prioritise a subset of keys to optimise the most common queries.
...
#+begin_src sql :eval no-export :session duckdb :wrap example :results verbatim  
  SET VARIABLE hive = '/datastore/alan/gsk/aliby_output/
  ELN201687/H00DJKJread1BF48hrs_20230926_095825hive_profiles_tracked/
  ,*/*/*.parquet';
